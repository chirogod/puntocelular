...
// Método para dibujar un círculo, no viene en FPDF por defecto
    function Circle($x, $y, $r)
    {
        $this->Ellipse($x, $y, $r, $r);
    }

    // Método para dibujar una elipse (adaptado de implementaciones comunes)
    ...
    // Función auxiliar para dibujar curvas Bézier
    ...
    // Método para dibujar el patrón celular (grilla 3x3 y líneas según patrón)
    function dibujarPatron($patron)
    {
        $radio = 3; // Radio del círculo
        $espacio = 8; // Espacio entre puntos
        $inicioX = 110; // Posición X donde empieza la grilla
        $inicioY = 10; // Posición Y donde empieza la grilla
        ...
        // Dibujar líneas entre puntos según el patrón
        $secuencia = explode('-', $patron);
        $this->SetDrawColor(0, 0, 0); // Color rojo para las líneas
        ...
        // Opcional: marcar los puntos del patrón con relleno
