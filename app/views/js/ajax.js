...
formularios_ajax.forEach(formulario => {
    formulario.addEventListener("submit", function(e) {
        ...
        // Verifica si el formulario es el de búsqueda
        if (formulario.classList.contains("FormularioBuscador")) {
            // Si es el formulario de búsqueda, envía directamente
            enviarFormulario(formulario);
        } else {
            // Para otros formularios, muestra la alerta de confirmación
            Swal.fire({
                title: '¿Estás seguro?',
