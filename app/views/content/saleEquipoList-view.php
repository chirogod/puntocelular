...
<div class="container is-fluid mb-6 is-max-desktop">
	<h1 class="title">Ventas de equipos</h1>
</div>
<div class="container is-max-desktop pb-1 pt-1">
    ...
    <?php
            echo $insVenta->listarVentaEquipoControlador($url[1],15,$url[0],$_SESSION[$url[0]]);
...
<div class="container is-max-desktop mt-3 mb-3">
	<?php
		$insVenta = new saleEquipoController();
		echo $insVenta->listarVentaEquipoControlador($url[1],15,$url[0],"");
	?>
</div>
