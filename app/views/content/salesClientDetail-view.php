...
<div class="container is-max-desktop pb-1 pt-1">
    ...
    <?php
            echo $insVenta->listarVentasClienteControlador($url[1],15,$url[0],$_SESSION[$url[0]], $id_cliente);
...
<div class="container is-max-desktop mt-3 mb-3">
	<?php
		$insVenta = new saleController();
		echo $insVenta->listarVentasClienteControlador($url[1],15,$url[0],"", $id_cliente);
	?>
</div>
